# Generated by Django 3.0.5 on 2021-06-17 11:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='api.Title', unique=True, verbose_name='Название объекта')),
            ],
            options={
                'verbose_name': 'Отзыв',
